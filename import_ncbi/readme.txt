Applies to TNRS DB versions 3.6.3 to 4.0
...
WARNING: Used existing data for this source. Do not refresh until scripts have 
been modified to support recent changes to NCBI taxonomy download schema
